...
for i in line:
    content = i[0]  # csv에서 뉴스 제목 또는 뉴스 본문 column으로 변
...
train_X_ = W2V.Convert2Vec("/Users/chaeyeonhwang/Documents/PBL/LSTM_material2/data/postnegpos3.embedding", train_X)  # import word2vec model where you have trained before
...
modelName = "Bi_LSTMposneg3.model"
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        for step in range(total_batch):
            ...
            saver.save(sess, 'Bi_LSTMposneg3.model')
